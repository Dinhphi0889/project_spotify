...
CREATE TABLE `LikedSong` (
  ...
  CONSTRAINT `LikedSong_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `User` (`userId`),
  CONSTRAINT `LikedSong_ibfk_2` FOREIGN KEY (`idSongLiked`) REFERENCES `Song` (`songId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE `ListFriends` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMess` int DEFAULT NULL,
  `idUser` int DEFAULT NULL,
  `isFriends` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idMess` (`idMess`),
  KEY `idUser` (`idUser`),
  CONSTRAINT `ListFriends_ibfk_1` FOREIGN KEY (`idMess`) REFERENCES `Message` (`idMess`),
  CONSTRAINT `ListFriends_ibfk_2` FOREIGN KEY (`idUser`) REFERENCES `User` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `Playlist` (
  ...
  CONSTRAINT `Playlist_ibfk_2` FOREIGN KEY (`genreId`) REFERENCES `Genre` (`genreId`),
  CONSTRAINT `Playlist_ibfk_3` FOREIGN KEY (`songs`) REFERENCES `Song` (`songId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `PlaylistLikes` (
  ...
  CONSTRAINT `PlaylistLikes_ibfk_2` FOREIGN KEY (`playlistId`) REFERENCES `Playlist` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `RecentPlayList` (
  ...
  KEY `userId` (`userId`),
  KEY `playlistId` (`playlistId`),
  CONSTRAINT `RecentPlayList_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `User` (`userId`),
  CONSTRAINT `RecentPlayList_ibfk_2` FOREIGN KEY (`playlistId`) REFERENCES `Playlist` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 1, 'Great song!', 13, '2024-01-01 00:00:00', NULL);
INSERT INTO `Discuss` (`userId`, `discussId`, `content`, `songId`, `discussDate`, `replayDiscussId`) VALUES
...
INSERT INTO `ListFriends` (`id`, `idMess`, `idUser`, `isFriends`) VALUES
(1, 1, 2, 1);
INSERT INTO `ListFriends` (`id`, `idMess`, `idUser`, `isFriends`) VALUES
(2, 1, 3, 1);
INSERT INTO `ListFriends` (`id`, `idMess`, `idUser`, `isFriends`) VALUES
...
(13, 1, 4, 'Lạc Trôi', 1000000, 240, 1, 'Hit song by Sơn Tùng M-TP', 'https://photo-resize-zmp3.zmdcdn.me/w600_r300x169_jpeg/thumb_video/4/a/4add7fcd19812492fb53e0ecd5125601_1483425414.jpg', '2017-01-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208633/LacTroi.mp3', 1);
INSERT INTO `Song` (`songId`, `userId`, `genreId`, `songName`, `viewer`, `duration`, `popular`, `description`, `songImage`, `publicDate`, `filePath`, `discussQuality`) VALUES
(14, 1, 4, 'Chạy Ngay Đi', 900000, 210, 1, 'Popular song by Sơn Tùng M-TP', 'https://upload.wikimedia.org/wikipedia/vi/thumb/8/85/Chay_ngay_di.png/220px-Chay_ngay_di.png', '2018-01-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208647/ChayNgayDi.mp3', 1);
INSERT INTO `Song` (`songId`, `userId`, `genreId`, `songName`, `viewer`, `duration`, `popular`, `description`, `songImage`, `publicDate`, `filePath`, `discussQuality`) VALUES
(15, 2, 1, 'Đừng Hỏi Em', 800000, 200, 1, 'Hit song by Mỹ Tâm', 'https://i.ytimg.com/vi/SNVE42IIY_s/maxresdefault.jpg', '2019-01-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208615/DungHoiEm.mp3', 1);
INSERT INTO `Song` (`songId`, `userId`, `genreId`, `songName`, `viewer`, `duration`, `popular`, `description`, `songImage`, `publicDate`, `filePath`, `discussQuality`) VALUES
(16, 2, 1, 'Người Hãy Quên Em Đi', 700000, 220, 1, 'Popular song by Mỹ Tâm', 'https://photo-resize-zmp3.zadn.vn/w600_r1x1_jpeg/cover/b/a/7/b/ba7bc87306fd23514ccb5c04b5c1f05a.jpg', '2019-06-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208591/NguoiHayQuenEmDi.mp3', 1),
(17, 3, 4, 'Anh Đếch Cần Gì Nhiều Ngoài Em', 600000, 230, 1, 'Hit song by Đen Vâu', 'https://i.ytimg.com/vi/KdrbBJNFwGw/maxresdefault.jpg', '2019-11-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208566/AnhDechCanGiNhieuNgoaiEm.mp3', 1),
(18, 3, 4, 'Lối Nhỏ', 500000, 240, 1, 'Popular song by Đen Vâu', '/images/loinho.jpg', '2020-01-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208547/LoiNho.mp3', 1),
(19, 4, 5, 'Tháng Tư Là Lời Nói Dối Của Em', 400000, 250, 1, 'Hit song by Hà Anh Tuấn', 'https://i.ytimg.com/vi/UCXao7aTDQM/maxresdefault.jpg', '2018-04-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208518/ThangTuVaLoiNoiDoiCuaEm.mp3', 1),
(20, 4, 5, 'Xuân Thì', 300000, 250, 1, 'Popular song by Hà Anh Tuấn', 'https://i.ytimg.com/vi/gt3U934kyPQ/maxresdefault.jpg', '2019-05-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208496/XuanThi.mp3', 1),
(21, 5, 1, 'Có Em Chờ', 200000, 250, 1, 'Hit song by Min', 'https://upload.wikimedia.org/wikipedia/vi/2/2e/B%C3%ACa_album_C%C3%B3_em_ch%E1%BB%9D.jpg', '2017-06-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208474/CoEmCho.mp3', 1),
(22, 5, 1, 'Đừng Yêu Nữa, Em Mệt Rồi', 100000, 280, 1, 'Popular song by Min', 'https://photo-resize-zmp3.zadn.vn/w600_r1x1_jpeg/cover/2/7/d/9/27d9bf0671538484ddc719c125cba369.jpg', '2018-07-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208443/DungYeuNuaEmMetRoi.mp3', 1),
(23, 6, 5, 'Em Không Sai, Chúng Ta Sai', 900000, 290, 1, 'Hit song by Erik', 'https://i.ytimg.com/vi/iwGuiSnr2Qc/maxresdefault.jpg', '2019-08-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208411/EmKhongSaiChungTaSai.mp3', 1),
(24, 6, 5, 'Có Tất Cả Nhưng Thiếu Anh', 800000, 300, 1, 'Popular song by Erik', 'https://i.ytimg.com/vi/LSjFMH1tsFc/maxresdefault.jpg', '2020-09-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208382/CoTatCaNhungThieuEm.mp3', 1),
(27, 7, 1, 'Bùa Yêu', 3000000, 250, 1, 'Popular song by Bích Phương', 'https://upload.wikimedia.org/wikipedia/vi/4/42/B%C3%ACa_%C4%91%C4%A9a_B%C3%B9a_y%C3%AAu_-_B%C3%ADch_Ph%C6%B0%C6%A1ng.png', '2024-07-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208361/BuaYeu.mp3', 700),
(28, 7, 1, 'Đi Đu Đưa Đi', 3500000, 220, 1, 'Hit song by Bích Phương', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_ieTDrsIz1nRnTUxWVy_TaLen6lHjN2t0Ig&s', '2024-08-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208328/DiDuDuaDi.mp3', 800),
(29, 8, 1, 'Cause I Love You', 1000000, 210, 1, 'Popular song by Noo Phước Thịnh', 'https://i.ytimg.com/vi/_E-7A81Ac8U/maxresdefault.jpg', '2024-01-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208301/CauseILoveYou.mp3', 100),
(30, 8, 1, 'Wanna Stay In Love', 1500000, 230, 1, 'Hit song by Noo Phước Thịnh', 'https://avatar-ex-swe.nixcdn.com/song/2016/06/17/6/d/d/8/1466144485971_640.jpg', '2024-02-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208279/WannaStayInLove.mp3', 200),
(31, 9, 1, 'Để Mị Nói Cho Mà Nghe', 2000000, 240, 1, 'Popular song by Hoàng Thùy Linh', 'https://upload.wikimedia.org/wikipedia/vi/b/bc/Deminoichomanghehtl.png', '2024-03-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208250/DeMiNoiChoMaNghe.mp3', 300),
(32, 9, 1, 'See Tình', 2500000, 215, 1, 'Hit song by Hoàng Thùy Linh', 'https://upload.wikimedia.org/wikipedia/vi/4/41/SeeTinhcover.jpg', '2024-04-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208228/SeeTinh.mp3', 400),
(33, 10, 5, 'Giả Vờ Yêu', 500000, 200, 1, 'Popular song by Ngô Kiến Huy', 'https://avatar-ex-swe.nixcdn.com/song/2023/02/08/f/b/7/8/1675844391876_640.jpg', '2024-05-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208202/GiaVoYeu.mp3', 500),
(34, 10, 1, 'Truyền Thái Y', 750000, 235, 1, 'Hit song by Ngô Kiến Huy', 'https://photo-resize-zmp3.zadn.vn/w600_r1x1_jpeg/cover/e/b/d/e/ebdeb9e23249e0aba569d7374250c39d.jpg', '2024-06-01', 'https://res.cloudinary.com/dmg28mhji/video/upload/v1721208124/TruyenThaiY.mp3', 600),
(35, 1, 2, '123aaa', 100, 300, 1, 'This is a sample song description', 'sample_song_image.jpg', '2024-07-14', 'path/to/sample_song.mp3', 5);

INSERT INTO `User` (`userId`, `account`, `name`, `nationality`, `chanalName`, `pathImage`, `desciption`, `refreshToken`, `password`, `banner`, `role`) VALUES
(1, 'sonTungMTP', 'Sơn Tùng M-TP', 'Vietnam', 'Sơn Tùng M-TP Channel', 'https://yt3.googleusercontent.com/oN0p3-PD3HUzn2KbMm4fVhvRrKtJhodGlwocI184BBSpybcQIphSeh3Z0i7WBgTq7e12yKxb=s900-c-k-c0x00ffffff-no-rj', 'Vietnamese pop singer and songwriter', '', 'password11', 'https://images.spiderum.com/sp-images/57559e00615611e7be8d59a5a1121573.jpg', 'Singer');
INSERT INTO `User` (`userId`, `account`, `name`, `nationality`, `chanalName`, `pathImage`, `desciption`, `refreshToken`, `password`, `banner`, `role`) VALUES
...
(11, 'test', 'John Doe', 'VietNam', 'pihihi', 'path/to/image', NULL, 'some_refresh_token', 'securepassword', 'path/to/banner', 'user'),
(26, 'sonTungMTP11111', 'Sơn Tùng M-TP', 'Vietnam', 'Sơn Tùng M-TP Channel', 'https://yt3.googleusercontent.com/oN0p3-PD3HUzn2KbMm4fVhvRrKtJhodGlwocI184BBSpybcQIphSeh3Z0i7WBgTq7e12yKxb=s900-c-k-c0x00ffffff-no-rj', 'Vietnamese pop singer and songwriter', '', '$2b$10$7e2wydkCTe1q62lqe69qzeuZaR2kBKDzp4Vnz../oi2BcguZunw5W', 'https://images.spiderum.com/sp-images/57559e00615611e7be8d59a5a1121573.jpg', 'Singer');
